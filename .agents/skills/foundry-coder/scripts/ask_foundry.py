#!/usr/bin/env python3
"""Foundry Local / Prism coder CLI. Thin entry point: the implementation lives in the local_coder package."""
...
from local_coder.compat_foundry import cli_main  # noqa: E402
